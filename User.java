...
public class User {
    ...
    private List<Book> books; //cartile scrise de scriitor!!! pt cititor va fi null
    @OneToOne(cascade = CascadeType.ALL, optional = false)
    @JoinColumn(name = "wId", referencedColumnName = "userId")
    private Wishlist wishlist;
    @OneToOne(cascade = CascadeType.ALL, optional = false)
    @JoinColumn(name = "fId", referencedColumnName = "userId")
